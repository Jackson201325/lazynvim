...
function M.get()
  ...
  M._keys = {
    ...
    { "<leader>o",  "<cmd>lua require('telescope.builtin').lsp_document_symbols({ symbol_width = 70, previewer = false, initial_mode = normal, layout_config = { width = 0.3, height = 0.15 } })<CR>", desc = "LSP Outline",                mode = { "n" } },
